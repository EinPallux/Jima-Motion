...
> **Status: v1.0 shipped** ✅ — the full Studio, **145 templates**, client-side MP4/WebM/GIF export,
...
Landing page → **Open the Studio** → choose one of **145 templates** (announcements, promos,
