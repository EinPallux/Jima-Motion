...
> **Status: v1.0 shipped** ✅ — the full Studio, **199 templates**, client-side MP4/WebM/GIF export,
...
Landing page → **Open the Studio** → choose one of **199 templates** (announcements, promos,
