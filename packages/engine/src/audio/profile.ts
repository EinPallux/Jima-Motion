 ...
 *
 * The old sound layer gave all 445 templates one vocabulary, which is the main
...
// Every category maps to a profile, so all 445 templates get something fitting
// without 445 edits. Overlays deliberately inherit `ui` and are trimmed further
