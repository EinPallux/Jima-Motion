...
**Current state: v1.0.0 shipped — all phases 0–6 complete.** Workspace/CI/guardrails; deterministic
motion engine + all 12 launch templates; client-side MP4/WebM/GIF export; the full Jima Studio UI;
