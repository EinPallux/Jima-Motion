...
> **Status: v1.0 shipped** ✅ — the full Studio, **35 templates**, client-side MP4/WebM/GIF export,
...
Landing page → **Open the Studio** → choose one of **35 templates** (announcements, promos,
quotes, stats, social-engagement moments — YouTube subscribe, Reel & TikTok follows, double-tap
hearts — kinetic type, travel cards, coupons, icon animations…) → edit text/images/colors/speed in a
simple form — no timeline, no keyframes → export MP4/WebM/GIF in 1:1, 4:5, 9:16 or 16:9.
