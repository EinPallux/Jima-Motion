...
**Current state: v1.0.0 shipped — all phases 0–6 complete; template library since expanded to 75.**
Workspace/CI/guardrails; deterministic motion engine + **75 templates** (12 launch + a 23-template
expansion + a 20-template smooth-text pack + a 20-template explainer/showcase/product/ad pack);
