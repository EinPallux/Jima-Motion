...
> **Status: v1.0 shipped** ✅ — the full Studio, **155 templates**, client-side MP4/WebM/GIF export,
...
Landing page → **Open the Studio** → choose one of **155 templates** (announcements, promos,
