...
> **Status: v1.0 shipped** ✅ — the full Studio, **160 templates**, client-side MP4/WebM/GIF export,
...
Landing page → **Open the Studio** → choose one of **160 templates** (announcements, promos,
